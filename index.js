...
// ✅ REMOVE: no need to re-initialize Firebase here
...
app.use(
  cors({
    origin: [
      "https://tpl-ludo-admin-dashboard-8khsndce3.vercel.app/",
      "https://tpl-ludo-admin-dashboard.vercel.app",
      "http://localhost:3000",
    ],
...
app.use("/api/v1/game-modes", gameModeRoutes);
